...
public class PlayerL03 : MonoBehaviour
{
    private float Hor;
    private float ver;
    public float speed;
    ...
    void Update()
    {
        ...
        if (transform.position.x > 188.47f)
        {

            transform.position = new Vector3(188.47f, transform.position.y, 0);
        }
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            PlayermanagerL03.isHit = true;
            if (Health.isHit)
            {
                Hit();
            }
        }
        if (collision.gameObject.tag == "inzone")
        {
            Debug.Log("inzone");
    ...
    public void Die()
    {
        ...
        dead.Play();
        PlayermanagerL03.isGameOver = true;
    }
    public void jump()
    {
    ...
    {
        trans.localScale=new Vector3(x,y);
    }
}
